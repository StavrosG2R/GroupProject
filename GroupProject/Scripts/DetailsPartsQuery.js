    ...
    $("#CaseId").on('change', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#CasesLabel').empty();
                console.log(data);
                $('#CasesLabel').append('<p>' + '<strong>Case Model: </strong>' + data.model + '<br/>' + '<strong>Case Size: </strong>' + data.size + '<br />' +
    ...
    $("#CpuId").on('change', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#CPULabel').empty();
                console.log(data);
                $('#CPULabel').append('<p>' + '<strong>CPU Model: </strong>' + data.model + '<br/>' + '<strong>Frequency: </strong>' + data.frequency + '<br />' +
    ...
    $("#MotherboardId").on('change', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                console.log(data);
                $('#MotherboardLabel').append('<p>' + '<strong>Motherboard Model: </strong>' + data.model + '<br/>' + '<strong>Chipset: </strong>' + data.chipset + '<br />' +
    ...
    $("#RamId").on('change', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#RamLabel').empty();
                console.log(data);
                $('#RamLabel').append('<p>' + '<strong>RAM Model: </strong>' + data.model + '<br/>' + '<strong>Frequency: </strong>' + data.frequency + '<br />' +
    ...
    $("#GpuId").on('change', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#GpuLabel').empty();
                console.log(data);
                $('#GpuLabel').append('<p>' + '<strong>GPU Model: </strong>' + data.model + '<br/>' + '<strong>Memory: </strong>' + data.vram + ' GB' + '<br />' +
    ...
    $("#StorageId").on('change', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('#StorageLabel').empty();
                console.log(data);
                $('#StorageLabel').append('<p>' + '<strong>Storage Model: </strong>' + data.model + '<br/>' + '<strong>Capacity: </strong>' + data.capacity + ' GB' + '<br />' +
